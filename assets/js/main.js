...
function renderAppearanceSection(){
  ...
  el.innerHTML = "<style id='np-collection-width-polish'>"
    ...
    +".profile-collection-shell .theme-collection-grid{grid-template-columns:repeat(auto-fill,minmax(225px,1fr)) !important;gap:12px !important;align-items:stretch !important;grid-auto-rows:340px !important;grid-auto-flow:row !important;}"
    +"body[data-theme-engine] .profile-collection-shell .np-theme-vault-card,body[data-theme-engine] .profile-collection-shell .np-theme-vault-card.is-featured,.profile-collection-shell .np-theme-vault-card,.profile-collection-shell .np-theme-vault-card.is-featured{grid-column:span 1 !important;grid-row:span 1 !important;align-self:stretch !important;box-sizing:border-box !important;min-height:0 !important;height:100% !important;max-height:340px !important;border-radius:12px !important;padding:15px !important;gap:10px !important;overflow:hidden !important;}"
    +".profile-collection-shell .np-theme-vault-card{display:grid !important;grid-template-rows:22px 112px minmax(58px,70px) 24px 46px !important;justify-content:stretch !important;align-content:start !important;}"
    +".profile-collection-shell .np-theme-vault-card::after{display:none !important;content:none !important;}"
    +".profile-collection-shell .theme-topline{height:22px !important;min-height:22px !important;max-height:22px !important;flex-shrink:0;}"
    ...
    +".profile-collection-shell .np-theme-vault-card[data-theme-id]{height:100% !important;max-height:340px !important;align-self:stretch !important;transform:none !important;}"
    ...
    +".profile-collection-shell .theme-card-body{height:70px !important;min-height:70px !important;max-height:70px !important;overflow:hidden;}"
    ...
    +".profile-collection-shell .theme-card-action{height:46px !important;min-height:46px !important;max-height:46px !important;padding:0 12px !important;border-radius:10px !important;font-size:9px !important;letter-spacing:1.6px !important;line-height:1 !important;flex-shrink:0;display:flex !important;align-items:center !important;justify-content:center !important;text-align:center !important;box-sizing:border-box !important;overflow:visible !important;}"
    +"@media(max-width:760px){.profile-collection-shell{width:100%;}.profile-collection-shell .theme-collection-grid{grid-template-columns:repeat(auto-fill,minmax(170px,1fr)) !important;grid-auto-rows:318px !important;}.profile-collection-shell .np-theme-vault-card,.profile-collection-shell .np-theme-vault-card.is-featured{height:100% !important;max-height:318px !important;padding:12px !important;grid-template-rows:22px 100px minmax(58px,70px) 24px 46px !important;}.profile-collection-shell .theme-preview-mini,.profile-collection-shell .np-theme-vault-card.is-featured .theme-preview-mini{height:100px !important;min-height:100px !important;max-height:100px !important;flex-basis:100px !important;}}"
