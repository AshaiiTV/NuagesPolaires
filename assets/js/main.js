...
function renderSpawnLab(tid){
  ...
  beasts.forEach(function(b){
    ...
    h+='<div class="sl-mini" style="margin-top:4px;display:flex;align-items:center;gap:6px;flex-wrap:wrap;">';
    h+='<span>Niv. '+esc(b.niv||1)+'</span>';
    h+=cBehaviorTag(b.beh||b.behavior||b.comportement,{fontSize:7,padding:'2px 6px',letterSpacing:'1px'});
    if(b.hidden) h+='<span style="font-size:9px;color:var(--red);padding:2px 6px;border:1px solid rgba(201,74,74,.24);background:rgba(201,74,74,.08);">Masquée</span>';
    h+='</div>';
